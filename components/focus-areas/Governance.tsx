      ...
      <section className="section-py">
        <div className="main-container grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-80 rounded-xl overflow-hidden shadow-md">
            <Image src="/images/focus/governance-1.jpg" fill className="object-cover" alt="Governance Work" />
          </div>
        </div>
      </section>
      ...
      <section className="section-py bg-muted/40">
        <div className="main-container grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-80 rounded-xl overflow-hidden order-2 md:order-1 shadow-md">
            <Image src="/images/focus/governance-2.jpg" fill className="object-cover" alt="Embedded Experience" />
          </div>
